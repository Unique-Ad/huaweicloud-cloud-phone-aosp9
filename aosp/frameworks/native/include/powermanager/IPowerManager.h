...
public:
    ...
    enum {
        ...
        IS_DEVICE_IDLE_MODE             = IBinder::FIRST_CALL_TRANSACTION + 15,
        IS_LIGHT_DEVICE_IDLE_MODE       = IBinder::FIRST_CALL_TRANSACTION + 16,
        ...
        GET_LAST_SHUTDOWN_REASON        = IBinder::FIRST_CALL_TRANSACTION + 21,
        SET_STAY_ON_SETTING             = IBinder::FIRST_CALL_TRANSACTION + 22,
        BOOST_SCREEN_BRIGHTNESS         = IBinder::FIRST_CALL_TRANSACTION + 23,
        IS_SCREEN_BRIGHTNESS_BOOSTED    = IBinder::FIRST_CALL_TRANSACTION + 24,
        SET_ATTENTION_LIGHT             = IBinder::FIRST_CALL_TRANSACTION + 25,
        SET_DOZE_AFTER_SCREEN_OFF       = IBinder::FIRST_CALL_TRANSACTION + 26,
    };
