...
typedef enum {
    ...
    HWC2_FUNCTION_UPDATE_ACTIVE_CONFIG_SIZE,
    HWC2_FUNCTION_EVENT_CONTROL,
...
static inline const char* getFunctionDescriptorName(
    ...
    switch (desc) {
        ...
        case HWC2_FUNCTION_UPDATE_ACTIVE_CONFIG_SIZE: return "UpdateActiveConfigSize";
...
enum class FunctionDescriptor : int32_t {
    ...
    UpdateActiveConfigSize = HWC2_FUNCTION_UPDATE_ACTIVE_CONFIG_SIZE,
    EventControl = HWC2_FUNCTION_EVENT_CONTROL,
...
/* updateActiveConfigSize(..., width, height)
 * Descriptor: HWC2_FUNCTION_UPDATE_ACTIVE_CONFIG_SIZE
 *
 * Parameters:
 *   width - the new width
 ...
 *       this display
 */
typedef int32_t /*hwc2_error_t*/ (*HWC2_PFN_UPDATE_ACTIVE_CONFIG_SIZE)(
        hwc2_device_t* device, hwc2_display_t display, uint32_t width, uint32_t height);

/* eventControl(..., event, enabled)
 * Descriptor: HWC2_PFN_EVENT_CONTROL
 *
 * Parameters:
 *   event - vsync or screen orientation
 *   enabled - enbable or disable the transaction
 *
 * Returns HWC2_ERROR_NONE or one of the following errors:
 *   HWC2_ERROR_BAD_DISPLAY - an invalid display handle was passed in
 *   HWC2_ERROR_BAD_CONFIG - the configuration handle passed in is not valid for
 *       this display
 */
typedef int32_t /*hwc2_error_t*/ (*HWC2_PFN_EVENT_CONTROL)(
        hwc2_device_t* device, hwc2_display_t display, int32_t event, int32_t enabled);
